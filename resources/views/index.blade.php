...
@section('content')
<div>
<section class="spotlight parallax" data-spotlight="fullscreen" style="background-image: url('{{ asset('theme/assets/images/backgrounds/img-1.jpg') }}'); background-repeat: no-repeat; background-size: cover;background-position: center ">
